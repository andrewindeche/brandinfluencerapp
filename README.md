...
5. Create Campaign: POST: http://localhost:4000/campaign
...
8. Campaign List Page: GET: http://localhost:4000/campaign
   payload: use Token.

9. Get Individual campaign by ID: GET: http://localhost:4000/campaign/ID

10. Get submission: GET:http://localhost:4000/campaign/:id/submissions

11. Get influencer by campaign: http://localhost:4000/campaign/:id/influencers

12. Refresh Token: http://localhost:4000/auth/refresh

13. Delete Campaign: DELETE /campaign/ID
